let words = [
    { "5A": "What was Jerry Seinfeld's apartment number?" },
    { "Cosmo": "What is Kramer's first name?" },
    { "Assistant to the Traveling Secretary": "What job does George Costanza pretend to have at the Yankees?" },
    { "The Sponge": "What is Elaine's favorite contraceptive that gets discontinued?" },
    { "Jambalaya": "What kind of soup does the Soup Nazi refuse to serve George?" },
    { "Susan Ross": "What was the name of George's fiancée who died from licking envelopes?" },
    { "Make Your Own Pizza Pie": "What was the name of Kramer's entrepreneur invention for pizza?" },
    { "Newman": "What is the name of Jerry's nemesis and neighbor?" },
    { "The Little Kicks": "What is Elaine's go-to dance move called?" },
    { "The Human Fund": "What is the title of George's fake charity?" },
    { "Saab": "What kind of car does Jerry drive?" },
    { "Monk's Café": "What is the name of the coffee shop the gang frequently visits?" },
    { "Jackie Chiles": "What was the name of Kramer's lawyer friend?" },
    { "The Drake's Wedding Cake": "What item did Elaine's boss, J. Peterman, eat that was worth $29,000?" },
    { "Art Vandelay": "What is the name of George's alter ego?" },
    { "Festivus": "What holiday does Frank Costanza invent?" },
    { "Superman": "What is Jerry's favorite superhero?" },
    { "Jujyfruits": "What does Elaine get banned for eating at Puddy's priest's church?" },
    { "Marble Rye": "What type of bread does Jerry steal from an old lady?" },
    { "Rochelle, Rochelle": "What is the name of the movie that Jerry and Elaine keep missing?" },
    { "Patrick Warburton": "Who plays Elaine's on-again, off-again boyfriend David Puddy?" },
    { "Donald": "What is the name of the bubble boy?" },
    { "Yev Kassem": "What is the real name of the Soup Nazi?" },
    { "Chess": "What game do George and his father play together?" },
    { "Junior Mint": "What type of candy does Kramer drop in the operating room?" },
    { "President of the condo association": "What does Jerry's father Morty Seinfeld do in Florida?" },
    { "J. Peterman": "What is the name of Elaine's boss at the J. Peterman catalog?" },
    { "The Manzier (or Bro)": "What does George wear to the beach that becomes famous?" },
    { "The Kramerica Industries": "What is Kramer's first business idea on the show?" },
    { "Leslie": "Who is the low-talker that convinces Jerry to wear the puffy shirt?" },
    { "Twix": "What kind of candy does George buy from the vending machine that gets stuck?" },
    { "Lt. Bookman": "What is the name of the library cop who investigates Jerry?" },
    { "Champion": "What was the name of the pony Elaine insults?" },
    { "Uncle Leo": "What is the name of Jerry's uncle?" },
    { "Get out!": "What does Elaine scream to get out of awkward situations?" },
    { "Scrooge": "What character does Kramer play in his community theater production?" },
    { "Mr. Wilhelm": "What is the name of George's boss at the Yankees?" },
    { "An antique toy": "What does Jerry accidentally break that belongs to his girlfriend?" },
    { "Jerry": "What is the title of the pilot Jerry and George pitch to NBC?" },
    { "A rooster": "What animal does Kramer accidentally release in the hospital?" },
    { "The Party Dip Incident": "What is the name of George's famous double-dip incident?" },
    { "A chocolate éclair from the trash": "What does Elaine eat that is deemed taboo?" },
    { "The Pieman": "What is the nickname of the woman who refuses to share her pie with Jerry?" },
    { "Crazy Joe Davola": "What is the name of the street tough who terrorizes Kramer and Newman?" },
    { "Under his desk at work": "What does George call the perfect nap spot?" },
    { "White socks with loafers": "What type of shoes does Elaine's boss Mr. Pitt insist on wearing?" },
    { "Vandelay Industries": "What is the name of the fictitious import/export company George claims to work for?" },
    { "Two-Face": "What is the name of the woman Jerry dates who looks different in different lighting?" },
